...
contract SendPackedUserOp is Script {
    ...
    address constant RANDOM_APPROVER = 0x0E9A8B9d13a3E70d2f8c509aB5767434aD1d9442;
    ...
    function generateSignedUserOperation(
        ...
        uint256 nonce = vm.getNonce(minimalAccount) - 1; // Decrement nonce to match the expected behavior of the EntryPoint
